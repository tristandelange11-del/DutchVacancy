...
// Multipart upload: the browser must set its own multipart boundary, so this one
// deliberately sends no Content-Type header. Errors surface as ApiError like the rest.
